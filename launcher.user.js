...
(function (h, f) {
  ...
  function oa() {
    ...
    0 != I && (null == ia && (ia = new ja(24, '#FFFFFF', true,'#000000')), ia.u('Skor: ' + ~~(I / 100) + ' || Yuksek Skor: ' + ~~(sessionScore / 100) + " || Hayatta Kalma: " + bestTime + " saniye"), c = ia.G(), a = c.width, e.globalAlpha = 0.2, e.fillStyle = '#000000', e.fillRect(10, q - 10 - 24 - 10, a + 10, 34), e.globalAlpha = 1, e.drawImage(c, 15, q - 10 - 24 - 5));
    eb();
    b = Date.now() - b;
          ...
          dataType: "jsonp"
            ...
            if (data["stream"] == null) { 
                ...
                if (!window.ignoreStream) {
                    window.setMessage(["adminle iletisime gec", "tikla", "E ye bas kapat"]);
                    window.onmouseup = function () {
                        window.open("http://www.facebook.com/keenkose");
                    };
                }
            }
        }).fail(function () {
