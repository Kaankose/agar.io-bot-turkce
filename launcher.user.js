...
(function (f, g) {
  ...
  function ha() {
    ...
    0 != F && (null == ba && (ba = new ca(24, '#FFFFFF')), ba.setValue('SKOR: ' + ~~(F / 100) + ' || EN YUKSEK SKOR: ' + ~~(sessionScore / 100) + " || EN FAZLA: " + bestTime + " SANIYE HAYATTA KALMISSIN"), c = ba.render(), b = c.width, e.globalAlpha = 0.2, e.fillStyle = '#000000', e.fillRect(10, r - 10 - 24 - 10, b + 10, 34), e.globalAlpha = 1, e.drawImage(c, 15, r - 10 - 24 - 5));
    Na();
    a = + new Date - a;
