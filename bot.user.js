// ==UserScript==
// @name        Agar io Bot Kaan Kose
// @namespace   Apos
// @description Plays Agar
// @include     http://agar.io/
// @version     1
// @grant       none
// @author      facebook.com/keenkose
// ==/UserScript==
...
(function (g, q) {
  ...
  function ba() {
    ...
    0 != M && (null == W && (W = new X(24, '#FFFFFF')), W.setValue('Skor: ' + ~~(M / 100) + ' || En Yuksek Skor: ' + ~~(sessionScore / 100)), c = W.render(), b = c.width, d.globalAlpha = 0.2, d.fillStyle = '#000000', d.fillRect(10, r - 10 - 24 - 10, b + 10, 34), d.globalAlpha = 1, d.drawImage(c, 15, r - 10 - 24 - 5));
    Fa();
    a = + new Date - a;
